...
[![coverage status](https://coveralls.io/repos/github/piotr-oles/async-status/badge.svg?branch=feature/add-coveralls)](https://coveralls.io/github/piotr-oles/async-status?branch=feature/add-coveralls)
